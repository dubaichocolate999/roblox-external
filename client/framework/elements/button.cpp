...
bool c_gui::button(std::string_view label, int val)
{
    ...
    draw->text_clipped(window->DrawList, var->font.tahoma, rect.Min, rect.Max, draw->get_clr(hovered ? clr->widgets.text : clr->widgets.text_inactive), label.data(), NULL, NULL, ImVec2(0.5f, 0.5f));
